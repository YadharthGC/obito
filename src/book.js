  ...
  return (
    <div className="container-fluid" id="booknow">
      ...
      >
        <div className="details" style={{ color: "black" }}>
          ...
          <div className="row" id="vehicle">
            <div className="col-lg-12" id="name">
              <label for="owner" style={{ color: "black" }}>
            ...
            <div className="col-lg-12" id="brands">
              <label for="brand" style={{ color: "black" }}>
                Vehicle Brand
              </label>
              <select
                id="brand"
            ...
            <div className="col-lg-12" id="type">
              <label for="model" style={{ color: "black" }}>
                Vehicle Model
              </label>
              <input
                type="text"
            ...
            <div className="col-lg-12" id="password">
              <div style={{ color: "black" }}>Set Date</div>
              <input
                type="radio"
                id="standard"
                name="srx"
                ...
                required
              />
              <label for="standard" style={{ color: "black" }}>
            ...
            {/* ////////////////////////////////////////////////// */}
            <div className="col-lg-12" id="password" style={{ color: "black" }}>
              <label for="pw" style={{ color: "black" }}>
                Set Time
              </label>
              <input
                type="time"
        ...
        <div className="jobs" style={{ color: "black" }}>
